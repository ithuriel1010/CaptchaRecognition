...
for f in files:
    list_files.append(f)
    list_labels.append(".".join(f.split(".")[:-1]))
...
# predict
y_pred = base_model.predict(testing_generator, max_queue_size=20, verbose=1)
print(y_pred.shape)
...
print(list_labels[30])
print(label_pred_greedy[30])
print(label_pred_beam[30])
